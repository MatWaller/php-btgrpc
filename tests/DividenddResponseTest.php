...
class GolddResponseTe extends TestCase
{
    /**
     * Set up test.
     *
    ...
    public function setUp()
    {
        ...
        $this->response = Gold\GolddResponse::createFrom($this->guzzleResponse);
    ...
    {
        $response = Gold\GolddResponse::createFrom(
    ...
    public function testCreateFrom()
    {
        ...
        $response = Gold\GolddResponse::createFrom($guzzleResponse);

        $this->assertInstanceOf(Gold\GolddResponse::class, $response);
    ...
    public function testSerialize()
    {
        ...
        $class = Gold\GolddResponse::class;
